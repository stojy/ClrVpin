...
public class FuzzyTests
{
    ...
    [TestCase("aV1 (IDSA 1986) Logo", "V1 (IDSA 1986) Logo.png", 220, TestName = "perfect match #3: match score succeeded because 'aV1' is camel case translated to 'a v1', 'a' is removed as a known word, and the ' ' whitespace prefix is trimmed")]
    [TestCase("bV1 (IDSA 1986) Logo", "V1 (IDSA 1986) Logo.png", 65, TestName = "perfect match #4: match score failed because the cleaned name does not have the version number parsed due to prefix non-whitespace")]
