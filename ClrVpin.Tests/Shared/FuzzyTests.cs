...
public class FuzzyTests
{
    ...
    [Test]
    [TestCase("medieval madness", false, false, "medieval madness", TestName = "nothing to do")]
    [TestCase("medieval madness.vpx", false, false, "medieval madness", TestName = "remove extension")]
    [TestCase("Twilight Zone Mod .vpx", true, false, "twilightzone", TestName = "remove mod")]
    [TestCase("Twilight Zone Mod.vpx", true, false, "twilightzone", TestName = "remove mod without trailing space")]
    [TestCase("Twilight Zone SG1bsoN.vpx", true, false, "twilightzone", TestName = "remove author 1")]
    [TestCase("Baywatch Starlion MoD", true, false, "baywatch", TestName = "remove author 1")]
    [TestCase("Twilight            Zone  baby.vpx", false, false, "twilight zone baby", TestName = "remove multiple spaces")]
    [TestCase("Twilight Zone V3.vpx", true, false, "twilightzone", TestName = "remove version - single digit")]
    [TestCase("Twilight Zone 3.vpx", true, false, "twilightzone3", TestName = "remove version - single digit without prefix prefix - number to remain")]
    [TestCase("Twilight Zone 3.0.vpx", true, false, "twilightzone", TestName = "remove version - double digit")]
    [TestCase("Twilight Zone 3_0.vpx", true, false, "twilightzone", TestName = "remove version - double digit with underscore")]
    [TestCase("Twilight Zone 30.00.10.vpx", true, false, "twilightzone", TestName = "remove version - triple digit")]
    [TestCase("Twilight Zone v1.2.vpx", true, false, "twilightzone", TestName = "remove version - double digit with prefix")]
    [TestCase("Twilight Zone v1.2 blah.vpx", true, false, "twilightzonev12blah", TestName = "remove version - version not at the end - number to remain")]
    [TestCase("Twilight Zone v1.2 - blah.vpx", true, false, "twilightzonev12blah", TestName = "remove version - version before hyphen and not at the end - number to remain")]
    [TestCase("Twilight Zone v1.2 - VP10.vpx", true, false, "twilightzone", TestName = "remove version with decimal - version before hyphen and IS at the end (VP10 keyword removed) - number to be stripped")]
    [TestCase("Twilight Zone v1_2 - VP10.vpx", true, false, "twilightzone", TestName = "remove version with underscore - version before hyphen and IS at the end (VP10 keyword removed) - number to be stripped")]
    [TestCase("._Twilight Zone SG1bsoN Mod V3.vpx", true, false, "twilightzone", TestName = "remove multple.. author, version, mod, etc")]
    [TestCase("2in1_", true, false, "2in1", TestName = "1_ is not confused with a parital version number")]
    [TestCase("the black knight", false, false, "black knight", TestName = "remove 'the'")]
    [TestCase("black&apos; knight", false, false, "black knight", TestName = "remove '&apos;'")]
    [TestCase("black' knight", false, false, "black knight", TestName = "remove '''")]
    [TestCase("blackï¿½ knight", false, false, "black knight", TestName = "remove 'ï¿½'")]
    [TestCase("black` knight", false, false, "black knight", TestName = "remove '`'")]
    [TestCase("black’ knight", false, false, "black knight", TestName = "remove '’'")]
    [TestCase("black, knight", false, false, "black knight", TestName = "remove ','")]
    [TestCase("black; knight", false, false, "black knight", TestName = "remove ';'")]
    [TestCase("black knight!", false, false, "black knight", TestName = "remove '!'")]
    [TestCase("black? knight", false, false, "black knight", TestName = "remove '?'")]
    [TestCase("JP's black knight", false, false, "black knight", TestName = "remove 'JP's")]
    [TestCase("JPs black knight", false, false, "black knight", TestName = "remove 'JPs")]
    [TestCase("black and knight", false, false, "black knight", TestName = "remove 'and'")]
    [TestCase("black a knight", false, false, "black knight", TestName = "remove ' a '")]
    [TestCase("a black knight", false, false, "black knight", TestName = "remove starting 'a '")]
    [TestCase("black.knight.blah", false, false, "black knight blah", TestName = "replace '.'")]
    [TestCase("black-knight", false, false, "black knight", TestName = "remove '-'")]
    [TestCase("black - knight", false, false, "black knight", TestName = "remove ' - '")]
    [TestCase("black_knight", false, false, "black knight", TestName = "remove '_'")]
    [TestCase("black&knight", false, false, "blackknight", TestName = "strip '&'")]
    [TestCase("black & knight", false, false, "black knight", TestName = "strip ' & '")]
    [TestCase("1 2 3 (Premier 1989)", true, false, "123premier1989", TestName = "#1 white space & parenthesis - removed")]
    [TestCase("1-2-3-(Premier 1989)", false, false, "1 2 3 premier 1989", TestName = "#2 white space  & parenthesis- removed")]
    [TestCase("1 2   3 (Premier 1989)", false, false, "1 2 3 premier 1989", TestName = "#3 white space  & parenthesis- removed")]
    [TestCase("1 2 3 (Premier 1989)", false, false, "1 2 3 premier 1989", TestName = "#4 white space - kept")]
    [TestCase("1234 blah", false, false, "1234 blah", TestName = "trim number preamble")]
    [TestCase("12345 blah", false, false, "blah", TestName = "trim number preamble")]
    [TestCase("Vp10-The Walking Dead 1.1.vpx", false, false, "walking dead", TestName = "remove vp10")]
    [TestCase("24`™ Pin·bot, Motörhead galáxia (Electromecánica)", false, false, "24 pinbot motrhead galxia electromecnica", TestName = "remove special and non-ascii characters - non-file")]
    [TestCase("24`™ Pin·bot Motörhead galáxia (Electromecánica)", false, true, "24™ pin·bot motörhead galáxia electromecánica", TestName = "remove special and non-ascii characters - file.. ` is removed, but non-ascii remain")]
    public void CleanPostSplitTest(string fileName, bool removeAllWhiteSpace, bool isFileName, string expectedName)
    {
        // confirm CleanPostSplit provides exact results - i.e. ignore scoring
        var cleanName = Fuzzy.CleanPostSplit(fileName, removeAllWhiteSpace, isFileName);
    ...
    [TestCase("Galaxia (LTD do Brasil 1975)", "Galáxia (LTD do Brasil 1975).vpx", 220, TestName = "ignore diacritics for strign comparison - a == á")]
