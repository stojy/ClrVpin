...
public class CommonFilterSettings
{
    ...
    public ObservableCollection<string> SelectedTableConstructionOptions { get; set; } = new() { TableStyleOptionEnum.Manufactured.ToString(), TableStyleOptionEnum.Original.ToString() };
}