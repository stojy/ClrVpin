...
namespace ClrVpin.Models.Settings
{
    public static class StaticSettings
    {
        ...
        public static HitType[] AllHitTypes =
        {
            ...
            new HitType(HitTypeEnum.Fuzzy, true, "Files that match the 'Fuzzy logic' algorithms (refer help page for more info)", "https://github.com/stojy/ClrVpin/wiki/Fuzzy-Logic"),
