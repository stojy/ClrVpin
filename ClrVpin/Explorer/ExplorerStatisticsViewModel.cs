...
{
    public class ExplorerStatisticsViewModel : StatisticsViewModel
    {
        public ExplorerStatisticsViewModel(ObservableCollection<LocalGame> games, TimeSpan elapsedTime, ICollection<FileDetail> fixedFiles, ICollection<FileDetail> unmatchedFiles)
